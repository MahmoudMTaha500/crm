...
<div class="modal fade" id="mediumModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{route('report-english-school')}}" method="GET">
                @csrf
    ...
    <div class="col-1">
        <button type="button" class="btn btn-secondary mb-1" data-toggle="modal" data-target="#mediumModal">
            Report
                    ...
                    <div class="col-1"></div>
                    @if(request('filter') && !$EnglishSchoolFinance->isEmpty())

                        <div class="col-2 ">
                            <a href="{{route('download-excel-english-school')}}"  class="btn btn-outline-success"> DownLoad Report As Excel  </a>

                        </div>
                        <div class="col-1"></div>

                        <div class="col-2 ">
                            <a href="{{route('download-pdf-english-school')}}"  class="btn btn-outline-danger" target="_blank"> DownLoad Report As Pdf  </a>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive table--no-card m-b-30">
                        <table class="table table-borderless table-striped table-earning">
                            ...
                            <tbody>
                                @forelse ($EnglishSchoolFinance as $finance)
                                    <tr>
                                        <td>{{$finance->id}}</td>
                ...
                @if(!$EnglishSchoolFinance->hasPages())
