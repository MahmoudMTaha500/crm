...
@section('admin.content')
    ...
    <div class="col-lg-12">
    <div class="card">
    <div class="card-header">Finance University Section </div>
    <div class="card-body">
    <div class="card-title">
    <h3 class="text-center title-2">Edit  finance University</h3>
    </div>
    <hr>
    <form action="{{route('finance-university.update',$financeUniversity->id)}}" method="post" novalidate="novalidate" enctype="multipart/form-data">
        @csrf
       @method('put')
      ...
      <div class="row">
          ...
          <div class="col-12">
            ...
            <label for="" class="control-label mb-1"> Students :</label>
              ...
              @foreach($students as  $student)
                <option   @if($student->id == $financeUniversity->request_uni->student_id) selected @endif value="{{$student->id}}">{{$student->name}}</option>
                @endforeach
              </select>
       ...
       <div style="border: #4272d7 2px solid; padding:5px;">
            <h2 style="text-align: center; margin:15px 0; color:#007bff">University Requests Details   </h2>
      <div class="row">
@php
    $universityRequests= $financeUniversity->request_uni;
@endphp

        <div class="col-4">
            <div class="form-group">
                <label class="typo__label">Universities</label>
                <select  name="uni" class="form-control selectpicker"  disabled data-live-search="true" id="uni_id">
          ...
          <div class="col-4">
              <div class="form-group">
                  ...
                  <select  name="agency" class="form-control selectpicker"  disabled data-live-search="true" id="agency_id">
          ...
          <div class="col-4">
              <div class="form-group">
                  ...
                  <input type="text" class="form-control" disabled value="{{$universityRequests->manual_id}}">
        ...
        <div class="col-2">
            <div class="form-group">
                ...
                <select class="form-control" style="border: 1px #888 solid; "  disabled name="kind_of_course" id="course_id">
        ...
        <div class="col-3">
                ...
                <input class="form-control" type="date" name="start_date" id=""  disabled placeholder="" value="{{$universityRequests->start_date}}">
            </div>
        ...
        <div class="col-2">
            <div class="form-group">
                ...
                <textarea class="form-control" name="note_course" id="" cols="10" disabled rows="2"> {{$universityRequests->text_note}}</textarea>
            </div>
        </div>
      </div>
        </div>
          <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input  name="paied" type="number" class="form-control" onchange="calc_remain()"  id='paied' value="{{$financeUniversity->pay}}" >
                </div>
                </div>
                <div class="col-4">
                <div class="form-group">
                    <label for="cc-payment" class="control-label mb-1">Remain  :</label>
                    <input  name="remain" type="number" class="form-control" readonly  id='remain' value="{{$financeUniversity->remain}}" >
                </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input  name="total" type="number" id="total" class="form-control" required  value="{{$financeUniversity->total}}" >
                </div>
                </div>
    ...
    <div class="row">
      ...
      <div class="col-3">
        <div class="form-group">
          ...
          <input  name="commission_percentage"  id='commission_percentage' type="number" class="form-control" required value="{{$financeUniversity->commission_percentage}}" >
      ...
      <div class="col-3">
        <div class="form-group">
          ...
          <input  name="commission_total" type="number" id='amount' readonly class="form-control" required  value="{{$financeUniversity->commission_total}}"  >
      ...
      <div class="col-3">
        <div class="form-group">
          ...
          <input  name="commission_received" type="number" id='received' readonly class="form-control" required  value="{{$financeUniversity->commission_received}}"  >
      ...
      <div class="col-3">
        <div class="form-group">
          ...
          <input  name="commission_remain" type="number" id='remain_comm' readonly class="form-control" required   value="{{$financeUniversity->commission_remain}}" >
          ...
          <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input  name="student_period" type="text" class="form-control" required  value="{{$financeUniversity->student_period}}" >
                </div>
                </div>

                <div class="col-4">
                <div class="form-group">
                    <label for="cc-payment" class="control-label mb-1">University Note  :</label>
                    <input  name="university_note" type="text" class="form-control" required  value="{{$financeUniversity->university_note}}" >
                </div>
                </div>
                <div class="col-4">
                  <div class="form-group">
                      <label for="cc-payment" class="control-label mb-1">Sat Note  :</label>
                      <input  name="sat_note" type="text" class="form-control" required  value="{{$financeUniversity->sat_note}}" >
                  </div>
                  </div>
            ...
            <div class="col-6">
              <div class="form-group">
                  ...
                  <select class="form-control"name="status_paied" id="">
                    ...
                    <option  @if($financeUniversity->status_paied == "Not paid yet") selected @endif value=" Not paid yet"> Not paid yet</option>
                    <option  @if($financeUniversity->status_paied == "Partially Paid") selected @endif value="Partially Paid">Partially Paid</option>
                    <option  @if($financeUniversity->status_paied == "All commission paid") selected @endif value="All commission paid">All commission paid</option>
                    </select>
              </div>
              </div>
            ...
            <div class="col-6">
              <div class="form-group">
                  ...
                  <select class="form-control"name="status_followed" id="">
                    <option  value="">Please Choose  Status</option>
                    <option  @if($financeUniversity->status_followed == "Not yet followed") selected @endif value=" Not yet followed"> Not yet followed</option>
                    <option  @if($financeUniversity->status_followed == "Following and Pending response") selected @endif value="Following and Pending response">Following and Pending response</option>
                    <option  @if($financeUniversity->status_followed == "Followed") selected @endif value="Followed">Followed</option>
                    </select>
              </div>
              </div>
          </div>
...
$("#remain_comm").val(remain_comm);
 ...
 $('#add_ele').click(function(){
  var html = ' <div class="row remve_ele"> <div class="col-6"><div class="form-group"> <label for="" class="control-label mb-1"> Commission :</label> <input  name="commission[]" type="number" class="form-control comm" required    placeholder="type your Commission">  </div>';
    html += '</div><div class="col-5"> <div class="form-group"><label for="cc-payment" class="control-label mb-1">Commission Date  :</label><input  name="commission_date[]" type="date" class="form-control" required  value=""></div></div> <div class="col-1">';
