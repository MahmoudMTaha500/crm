    ...
    .modal-backdrop{
        z-index: -1;
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive table--no-card m-b-30">
                        <table class="table table-borderless table-striped table-earning">
                            ...
                            <tbody>
                                @foreach($Place_of_study as $place)
                                <tr>
                                    <td>{{$place->id}}</td>
                                    <td>{{$place->name}}</td>
                                  ...
                                  <td>
                                    <div class="table-data-feature">
                                        ...
                                        <a href="{{route('place.edit',$place->id)}}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                ...
                {{$Place_of_study->appends(request()->input())->links()}}
