                                ...
                                <tr>
                                  ...
                                  <td>
                                    <div class="table-data-feature">
                                        ...
                                        <a href="{{route('course-english-school.edit',$course->id)}}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <form action="{{route('course-english-school.destroy', $course->id)}}" method="POST">
                                            @csrf
                                            @method('delete')
