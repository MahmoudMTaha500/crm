        ...
        z-index: -1;
                ...
                <div class="modal fade" id="mediumModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            ...
                            <form action="{{route('finance-english-school.index')}}" method="GET">
                             @csrf 
			...
			<!-- end modal small -->
                <div class="row">
                    ...
                    <H2  style="color: #0c3386">  English School Requests Finance </H2>
                  </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="table-responsive table--no-card m-b-30">
                        <table class="table table-borderless table-striped table-earning">
                            ...
                            <tbody>
                                @foreach($EnglishSchoolFinance as $finance)
                                ...
                                <tr>
                                    ...
                                    <td>{{$finance->request_institute->student->phone}}</td>
                                    <td>{{$finance->request_institute->student->student_type}}</td>
                                    <td>{{$finance->request_institute->student->nationality}}</td>
                                    ...
                                    <td>{{$finance->request_institute->text_note}}</td>
                                    ...
                                    {{-- <td>{{$finance->request_institute->agency->name}}</td> --}}
                                    <td>{{$finance->pay}}</td>
                                    ...
                                    <td>{{$finance->english_school_note}}</td>
                                  ...
                                  <td>
                                    <div class="table-data-feature">
                                        ...
                                        <a href="{{route('finance-english-school.edit',$finance->id)}}" class="item" data-toggle="tooltip" data-placement="top" title="Edit">
                                            <i class="zmdi zmdi-edit"></i>
                                        </a>
                                        <a href="{{route('student.show',$finance->request_institute->student_id)}}" class="item" data-toggle="tooltip" data-placement="top" title="show" target="_blank">
                                            <i class="zmdi zmdi-eye"></i>
                                        </a>
                                        <form action="{{route('finance-english-school.destroy', $finance->id)}}" method="POST">
                                            @csrf
                                            @method('delete')
                ...
                {{$EnglishSchoolFinance->appends(request()->input())->links('pagination::bootstrap-4')}}
