...
class CreateEnglishSchoolFinancesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('english_school_finances', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('request_id')->unsigned();
            $table->foreign('request_id')->references('id')->on('english_school_requests')->onDelete('cascade');
            $table->integer('total');
            ...
            $table->string('english_school_note')->nullable();
    ...
    {
        Schema::dropIfExists('english_school_finances');
    }
}
