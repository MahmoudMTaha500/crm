...
// dd($fromDate);
            ...
            if($request->country_id){
                // $EnglishSchoolRequestss=   $universityRequestss->where('country_id',$request->country_id);
            ...
            if($request->city_id){
            // $EnglishSchoolRequests->where('city_id',$request->city_id);
    ...
    //    $EnglishSchoolRequests = EnglishSchoolRequests::get();
